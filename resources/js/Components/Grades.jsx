...
const Grades = ({ data, subject }) => {
  ...
  return (
    <div>
      ...
      <DataTable value={filteredData} paginator rows={4}>
        ...
        <Column
          field="grade"
          header={
            selectedGradeType.value === "quantitative"
              ? "Calificación"
              : "Calificación en Letras"
          }
          body={gradeTypeTemplate}
          sortable
        />
        <Column
          header="Acciones"
      ...
      <Dialog
        ...
        header={
          editMode
            ? `Editar la calificación de ${subject.name} del alumno ${
      ...
      >
        ...
        {selectedGradeType.value === "qualitative" && (
          <div className="p-field">
            <label htmlFor="letterGrade">Calificación en Letras</label>
            <Dropdown
              id="letterGrade"
