        ...
        <MainFormFieldset legend="DATOS DE IDENTIFICACIÓN/INFORMACIÓN ESTUDIANTE">
            ...
            >
                ...
                <InputCalendar
                    ...
                    name="birth_date"
                    value={
                        data?.identification_data?.birth_date
                            ? new Date(data?.identification_data?.birth_date)
                            : ""
                    }
                    type="date"
                    required
            ...
            >
                ...
                <InputPhoneType
                    tel_id="phone"
                    tel_name="phone"
                    tel_value={data?.identification_data?.phone}
                    required
                    placeholder="Ingrese el número de teléfono"
                    type_id="phone_type_id"
                    type_name="phone_type_id"
                    type_value={data?.identification_data?.phone_type_id}
                    className="rounded-md w-full placeholder:font-normal"
                    onChange={handleIdentificationData}
                />
                {errorHandling?.phone && (
